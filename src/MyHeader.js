...
const menu3 = (
    <Menu>
        <Menu.Item>
            <a target="_blank" rel="noopener noreferrer" href="/mynews?ban_kuai=活动管理&lan_mu=发布激励&tittle=默认">
            发布激励
        </a>
        </Menu.Item>
        <Menu.Item>
            <a target="_blank" rel="noopener noreferrer" href="/mynews?ban_kuai=活动管理&lan_mu=兑现激励&tittle=默认">
            兑现激励
        </a>
        </Menu.Item>
        <Menu.Item>
